export default function Bar() {
  return (
    <div className="absolute text-xs w-11/12 bottom-12 lg:bottom-4 lg:left-10 xl:left-12 font-extralight text-black rounded-md hidden md:inline md:left-8 bg-white">
      <div className="flex justify-between items-center p-2">
        <div className="flex items-center px-2 border border-linecolor rounded-md">
        ...
        <div className="flex w-20 justify-between mr-4">
          <span classname="h-8">
