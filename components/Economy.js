  ...
  return (
    <div className="bg-ai text-white h-screen relative w-screen">
      ...
      <img
        ...
        className="w-1/4 absolute bottom-12 left-1/3 z-10 md:w-4/12 md:bottom-0 md:left-auto md:right-12"
      />
      <img src={pageInfo.data.graph.url} className="hidden md:inline absolute md:bottom-0 lg:w-12/12 lg:right-0 z-10" />
      <img src={pageInfo.data.background.url} className="absolute h-screen top-0" />
    </div>
  );
}
