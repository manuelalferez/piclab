export default function Beta({ beta }) {
  return (
    <div className="h-screen relative bg-betacolor flex flex-col justify-center text-xs">
      ...
      <div className="sticky bg-white z-10 text-black md:w-6/12 lg:w-4/12 md:mx-auto md:p-2 md:px-4 flex items-center mx-4 px-2 border border-linecolor rounded-md">
