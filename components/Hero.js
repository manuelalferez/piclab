...
export default function Hero({ hero }) {
  return (
    <div className="h-screen relative overflow-hidden bg-gradient-to-r from-primary to-secondary">
      ...
      <div className="absolute hidden object-scale-down md:inline md:bottom-24 md:right-0 md:w-4/5 md:h-1/3 lg:top-60 lg:-right-12 lg:w-3/4 xl:w-max xl:top-12 xl:-right-8 2xl:top-40 2xl:right-0">
